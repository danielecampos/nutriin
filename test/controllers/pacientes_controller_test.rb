...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { bairro: @paciente.bairro, cep: @paciente.cep, cep: @paciente.cep, cidade: @paciente.cidade, cpf: @paciente.cpf, data_nasc: @paciente.data_nasc, email: @paciente.email, estado: @paciente.estado, logradouro: @paciente.logradouro, nome: @paciente.nome, numero: @paciente.numero, pais: @paciente.pais, sexo: @paciente.sexo } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { bairro: @paciente.bairro, cep: @paciente.cep, cep: @paciente.cep, cidade: @paciente.cidade, cpf: @paciente.cpf, data_nasc: @paciente.data_nasc, email: @paciente.email, estado: @paciente.estado, logradouro: @paciente.logradouro, nome: @paciente.nome, numero: @paciente.numero, pais: @paciente.pais, sexo: @paciente.sexo } }
