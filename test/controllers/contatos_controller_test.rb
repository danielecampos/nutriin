...
class ContatosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post contatos_url, params: { contato: { ativo: @contato.ativo, ddd: @contato.ddd, numero: @contato.numero, paciente_id: @contato.paciente_id, tipo: @contato.tipo } }
    end
  ...
  test "should update contato" do
    patch contato_url(@contato), params: { contato: { ativo: @contato.ativo, ddd: @contato.ddd, numero: @contato.numero, paciente_id: @contato.paciente_id, tipo: @contato.tipo } }
