class PacientesController < ApplicationController
  ...
  def new
    ...
    respond_to do |format|
      format.js { render template: 'pacientes/modal.js.erb' }
    end
  end
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:nome, :cpf, :data_nasc, :sexo, :email, :logradouro, :numero, :bairro, :cep, :cep, :cidade, :estado, :pais)
    end
end
